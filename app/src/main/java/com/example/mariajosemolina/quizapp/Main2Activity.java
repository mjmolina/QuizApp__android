...
public class Main2Activity extends AppCompatActivity {
    ...
    public void set_image_to_question(ImageView img, int index) {

        // We get the category of the question at index
        String category = questions.get(index).get(0);
    ...
    public void set_questions_on_screen() {
        ...
        set_image_to_question(q1_image, 0);
        set_image_to_question(q2_image, 1);
        set_image_to_question(q3_image, 2);
        set_image_to_question(q4_image, 3);
        set_image_to_question(q5_image, 4);
    ...
    public void evaluate_questions() {
        ...
        result += check_question(q1_buttons, 0, q1_message);
        result += check_question(q2_buttons, 1, q2_message);
        result += check_question(q3_buttons, 2, q3_message);
        result += check_question(q4_buttons, 3, q4_message);
        result += check_question(q5_buttons, 4, q5_message);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialisation of the questions data
        init_questions();
